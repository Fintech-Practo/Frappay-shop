    ...
    <Layout>
      <div className="container-custom py-8">
        <div className="flex flex-col md:flex-row justify-between gap-4 mb-6">
          <h1 className="text-3xl font-bold">Stationery</h1>
        ...
        {loading ? (
          <div className="text-center py-20">Loading stationery…</div>
        ) : products.length === 0 ? (
          <div className="text-center py-20">No stationery found</div>
        ) : (
          <>
